<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InfoAzucar.aspx.cs" Inherits="WebAppSeguimiento.InfoAzucar" %>
                    ...
                    <br />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Placas:</label>
                                    <asp:TextBox ID="txtplacas" runat="server" CssClass="form-control" required></asp:TextBox>
                                </div>  
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtOperador" runat="server" CssClass="form-control" required></asp:TextBox>
                                </div>  
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>SKU:</label>
                                    <asp:DropDownList ID="ddlSKU" runat="server" CssClass="form-control">
                                    </asp:DropDownList>
                                </div>  
                            </div>
                        </div>
