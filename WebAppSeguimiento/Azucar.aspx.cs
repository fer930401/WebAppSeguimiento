...
{
    public partial class Azucar : System.Web.UI.Page
    {
        ...
        {
            GridView1.DataSource = logicaNegocio.consultaSeguimiento("", "2", 0);
            GridView1.DataBind();
        }
        ...
        protected void ddlFechas_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlFechas.SelectedValue.Equals("NA") == false)
            {
                ...
                GridView1.DataSource = logicaNegocio.consultaSeguimiento(fecha, "2", 1);
                GridView1.DataBind();
            }
            else
            {
